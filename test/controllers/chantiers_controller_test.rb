...
class ChantiersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chantier" do
    assert_difference("Chantier.count") do
      post chantiers_url, params: { chantier: { client_id: @chantier.client_id, nom: @chantier.nom } }
    end
  ...
  test "should update chantier" do
    patch chantier_url(@chantier), params: { chantier: { client_id: @chantier.client_id, nom: @chantier.nom } }
